export default {
  ...
  follow_link: {
    invalid_title: 'This follow link is no longer active',
    invalid_body: 'The household may have revoked it, or it expired. Ask them to send a fresh one.',
    invalid_action: 'Back to Dishton',
    heading: 'Follow {{name}}?',
    body: "You'll get read-only access to their recipes. They can revoke this link at any time.",
    signup_action: 'Sign up to follow',
    login_action: 'Log in',
    follow_action: 'Follow',
    already_title: 'You already follow {{name}}',
    already_action: 'Open their kitchen',
    own_title: 'This is your own household',
    own_body: "You can't follow your own kitchen.",
    own_action: 'Back to Dishton',
  },
  search: {
    title: 'Search',
    nav: 'Search',
  ...
  household_settings: {
    ...
    sharing: {
      ...
      help: 'A follow link lets another household subscribe to this one read-only. Links expire after 30 days and stay usable until you revoke them.',
      ...
      redeem_hint:
        'Share the link (or code) with another household. Anyone who has it can follow you until you revoke it or it expires.',
      copy_link: 'Copy link',
  ...
  recipe: {
    ...
    save_link_failed_title: 'Couldn’t save',
    save_link_failed_body: 'Something went wrong saving this recipe. Try again in a moment.',
    linked_badge: 'Followed recipe — kept in sync with the original',
    remove_link_action: 'Remove from my pantry',
    remove_link_confirm_title: 'Remove from your pantry?',
    remove_link_confirm_body:
      'This only removes "{{title}}" from your pantry. The original recipe stays untouched.',
    remove_link_confirm: 'Remove',
    remove_link_cancel: 'Cancel',
    remove_link_success_title: 'Removed from your pantry',
    remove_link_success_body: '"{{title}}" is no longer in your pantry.',
    remove_link_failed_title: 'Couldn’t remove',
    remove_link_failed_body: 'Something went wrong. Try again in a moment.',
  ...
  admin: {
    metrics: {
      title: 'Metrics',
      subtitle: 'Product and reliability observability, admin-only.',
      date_range_label: 'Date range',
      date_range_days: '{{count}}d',
      column_day: 'Day',
      ...
      active_users: {
        ...
        chart_label: 'Daily, weekly and monthly active users over time',
        dau: 'Daily',
        wau: 'Weekly (rolling 7d)',
        mau: 'Monthly (rolling 30d)',
      },
      app_opens: {
        title: 'App opens',
        subtitle: 'How often the app is opened, and whether it was installed as a PWA.',
        chart_label: 'App opens per day, standalone vs browser',
        total_opens: 'Opens',
        resumes: 'Resumes',
        unique_sessions: 'Sessions',
        standalone: 'Installed app',
        browser: 'Browser tab',
        standalone_share: '{{percent}}% of opens were from the installed app.',
      },
      imports: {
        title: 'Imports',
        subtitle: 'Recipe import volume, success rate and latency.',
        chart_label: 'Imports started per day',
        started: 'Started',
        succeeded: 'Succeeded',
        failed: 'Failed',
      ...
      ai_cost: {
        title: 'AI cost',
        subtitle: 'Anthropic spend across every import, translation and chat call.',
        chart_label: 'AI spend in USD per day',
        total_usd: 'Total spend',
        total_calls: 'Calls',
        by_model: 'By model',
        model: 'Model',
        tokens_in: 'Tokens in',
        ...
        unpriced_warning:
          '{{count}} call(s) used a model with no price row — spend is under-reported for those calls. Add a row to app.ai_model_prices.',
      },
      edge_reliability: {
        title: 'Edge reliability',
        subtitle: 'Edge Function call outcomes, and imports stuck mid-flight.',
        chart_label: 'Edge Function calls per day, ok vs failed',
        ok: 'Ok',
        failed: 'Failed',
        by_function: 'By function and outcome',
        function: 'Function',
        outcome: 'Outcome',
        calls: 'Calls',
        stuck_imports: 'Stuck imports',
        no_stuck_imports: 'No stuck imports right now.',
        status: 'Status',
        started_at: 'Started',
        age_minutes: 'Age (min)',
        outcomes: {
