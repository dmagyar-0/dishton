export default {
  ...
  chat: {
    ...
    cancel: 'Cancel',
    empty_heading: 'Draft a recipe with AI',
    empty_body: 'Describe what you want to cook and the AI will build a recipe as you chat.',
    suggestion_seasonal: 'Something seasonal with root vegetables',
    suggestion_quick: 'A quick weeknight dinner under 30 minutes',
    suggestion_vegetarian: 'A hearty vegetarian meal for four',
  },
  nav: {
    home: 'Home',
    ...
    tab_bar_label: 'Quick navigation',
  },
  auth: {
    login: 'Sign in',
  ...
  recipe: {
    ...
    quantity_invalid: 'Enter a number like 1, 1.5, 1/2, or 1 1/2.',
