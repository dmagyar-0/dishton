export default {
  ...
  follow_link: {
    invalid_title: 'Dieser Folge-Link ist nicht mehr aktiv',
    invalid_body:
      'Der Haushalt hat ihn vielleicht widerrufen, oder er ist abgelaufen. Bitte um einen neuen Link.',
    invalid_action: 'Zurück zu Dishton',
    heading: '{{name}} folgen?',
    body: 'Du bekommst Lesezugriff auf ihre Rezepte. Sie können diesen Link jederzeit widerrufen.',
    signup_action: 'Registrieren zum Folgen',
    login_action: 'Anmelden',
    follow_action: 'Folgen',
    already_title: 'Du folgst {{name}} bereits',
    already_action: 'Ihre Küche öffnen',
    own_title: 'Das ist dein eigener Haushalt',
    own_body: 'Du kannst deiner eigenen Küche nicht folgen.',
    own_action: 'Zurück zu Dishton',
  },
  search: {
    title: 'Suche',
    nav: 'Suche',
  ...
  household_settings: {
    ...
    sharing: {
      ...
      help: 'Mit einem Folge-Link kann ein anderer Haushalt eure Rezepte schreibgeschützt abonnieren. Links laufen nach 30 Tagen ab und bleiben bis dahin nutzbar, sofern ihr sie nicht widerruft.',
      ...
      redeem_hint:
        'Teile den Link (oder Code) mit einem anderen Haushalt. Wer ihn hat, kann euch folgen, bis ihr ihn widerruft oder er abläuft.',
  ...
  admin: {
    metrics: {
      title: 'Metriken',
      subtitle: 'Produkt- und Zuverlässigkeits-Observability, nur für Admins.',
      date_range_label: 'Zeitraum',
      date_range_days: '{{count}}T',
      column_day: 'Tag',
      ...
      active_users: {
        ...
        chart_label: 'Tägliche, wöchentliche und monatliche aktive Nutzer im Zeitverlauf',
        dau: 'Täglich',
        wau: 'Wöchentlich (gleitend, 7 Tage)',
        mau: 'Monatlich (gleitend, 30 Tage)',
      },
      app_opens: {
        title: 'App-Öffnungen',
        subtitle: 'Wie oft die App geöffnet wird und ob sie als PWA installiert ist.',
        chart_label: 'App-Öffnungen pro Tag, installierte App vs. Browser',
        total_opens: 'Öffnungen',
        resumes: 'Fortsetzungen',
        unique_sessions: 'Sitzungen',
        standalone: 'Installierte App',
        browser: 'Browser-Tab',
        standalone_share: '{{percent}} % der Öffnungen kamen aus der installierten App.',
      },
      imports: {
        title: 'Importe',
        subtitle: 'Rezept-Importvolumen, Erfolgsquote und Latenz.',
        chart_label: 'Gestartete Importe pro Tag',
        started: 'Gestartet',
      ...
      ai_cost: {
        title: 'KI-Kosten',
        subtitle: 'Anthropic-Ausgaben über jeden Import-, Übersetzungs- und Chat-Aufruf.',
        chart_label: 'KI-Ausgaben in USD pro Tag',
        total_usd: 'Gesamtausgaben',
        total_calls: 'Aufrufe',
        by_model: 'Nach Modell',
        model: 'Modell',
        tokens_in: 'Tokens ein',
        tokens_out: 'Tokens aus',
        unpriced_calls: 'Unbepreiste Aufrufe',
        unpriced_warning:
          '{{count}} Aufruf(e) verwendeten ein Modell ohne Preiszeile — die Ausgaben für diese Aufrufe werden zu niedrig ausgewiesen. Füge app.ai_model_prices eine Zeile hinzu.',
      },
      edge_reliability: {
        title: 'Edge-Zuverlässigkeit',
        subtitle: 'Ergebnisse von Edge-Function-Aufrufen und mitten hängengebliebene Importe.',
        chart_label: 'Edge-Function-Aufrufe pro Tag, ok vs. fehlgeschlagen',
        ok: 'Ok',
        failed: 'Fehlgeschlagen',
        by_function: 'Nach Funktion und Ergebnis',
        function: 'Funktion',
        outcome: 'Ergebnis',
        calls: 'Aufrufe',
        stuck_imports: 'Hängende Importe',
        no_stuck_imports: 'Aktuell keine hängenden Importe.',
        status: 'Status',
