...
--
-- Personas:
--   W = 00000000-0000-0000-0000-0000000000b1  (signs up with display_name metadata)
--   X = 00000000-0000-0000-0000-0000000000b2  (signs up without display_name metadata)
--   Y = 00000000-0000-0000-0000-0000000000b3  (signs up with whitespace-only display_name)
...
select 'trigger also creates personal household for metadata-signup user',
       count(*) = 1
from app.households
where owner_profile_id = '00000000-0000-0000-0000-0000000000b1'
  and is_personal;
